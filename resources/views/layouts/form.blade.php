...
<body class="bg-default">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="{{ route('login') }}">
                ...
                <span class="nav-link-inner--text">Iniciar Sessión</span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-white">
              © 2022 <a href="/" class="font-weight-bold ml-1 text-white" target="_blank">{{ config('app.name')}}</a>
            </div>
          </div>
          <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-xl-end">
              <li class="nav-item">
                <a href="/" class="nav-link text-white" target="_blank">AutoSis</a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link text-white" target="_blank">Acerca de</a>
              </li>
            </ul>
          </div>
        </div>
  ...
  <!-- jquery -->
  <script src="{{ secure_asset('jquery-3.6.1.min.js')}}"></script>
